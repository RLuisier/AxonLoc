...
mp<-barplot(unlist(lapply(comp.cb.i,length)),las=1,ylim=c(0,30000),col=mycols[1],cex.axis=0.7)
...
mp<-barplot(unlist(lapply(comp.ax.i,length)),las=1,ylim=c(0,30000),col=mycols[2],cex.axis=0.7)
mtext(side=1,line=0,text=c("both","NGF only","NT3 only"),at=mp,cex=0.7)
...
mp<-barplot(unlist(lapply(comp.cb,length)),las=1,ylim=c(0,14000),col=mycols[1],cex.axis=0.7)
mtext(side=1,line=0,text=c("both","NGF only","NT3 only"),at=mp,cex=0.7)
mtext(side=3,line=0,text=unlist(lapply(comp.cb,length)),at=mp,cex=0.7)
mtext(side=2,line=2,text="# transcript ID detected in CB",cex=0.7)

mp<-barplot(unlist(lapply(comp.ax,length)),las=1,ylim=c(0,14000),col=mycols[2],cex.axis=0.7)
mtext(side=1,line=0,text=c("both","NGF only","NT3 only"),at=mp,cex=0.7)
