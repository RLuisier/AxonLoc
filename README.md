...
To run the jupyter notebook, create a python environment with conda by running the command `conda create --name <env> --file python_requirements.txt` (tested on osx-64).
