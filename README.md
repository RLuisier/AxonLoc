...
To run the jupyter notebook, create a python environment with conda by running the command `conda create --name <env_name> --file python_requirements.txt` (tested on osx-64). Then, acitvate the environment my running `conda activate <env_name>`.
