...
To run the jupyter notebook, create a python environment with conda by running the command `conda create --name <env_name> --file python_requirements.txt` (tested on osx-64). Then, you can activate the environment by running `conda activate <env_name>`.
